...
namespace GUI.LopHoc
{
    public partial class fThemDeThiCuaLop : Form
    {
        ...
        public fThemDeThiCuaLop(DeThiDTO deThi, LopDTO lop,fChiTietLop fCTL, fDanhSachDeThi fDSDT = null, string hanhDong = null)
        {
            InitializeComponent();
        ...
        public fThemDeThiCuaLop(DeThiDTO deThi, LopDTO lop, fChiTietLop fCTL, string hd = null)
        {
            InitializeComponent();
            this.deThi = deThi;
            this.lop = lop;
